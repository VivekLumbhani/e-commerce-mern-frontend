  ...
  export const cartReducer = (state = initialState, action) => {
    switch (action.type) {
      ...
      case ADD_ITEM_TO_CART_SUCCESS:
        return { ...state, cartItems: [...state.cartItems, action.payload], loading: false, error: null };
  
      case GET_CART_SUCCESS:
        return { ...state, cartItems: action.payload.cartItems, loading: false, error: null };
