      ...
      <Grid container spacing={2} sx={{ justifyContent: "space-between" }}>
        <Grid item xs={6}>
          <div className="flex cursor-pointer">
            ...
            <div className="ml-5 space-y-2">
              <p className="mb-2">Mens kurta white</p>
        ...
        <Grid item xs={4}>
          {true && (
            <div>
<p>
                <AdjustIcon sx={{width:"15px",height:"15px"}} className=" text-gray-600 mr-2
                 text-sm"/>
              <span>Delivered On April 10</span>
          ...
          {false && <p>
            <span>Expected Delivery On April 18</span>
          </p>}
        </Grid>
      </Grid>
    </div>
